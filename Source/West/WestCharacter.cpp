...
void AWestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AWestCharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool AWestCharacter::GetHasRifle()
{
	return bHasRifle;
}